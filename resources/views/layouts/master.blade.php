...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper" id="app">
        ...
        <header class="main-header">
            ...
            <!-- Logo -->
            <a href="{{url('/siteAdmin')}}" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>M</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"> Simle Pure </span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <img src="{{ @Auth::user()->image->name ? '/img/users/'.@Auth::user()->image->name : url('/dist/img/user2-160x160.jpg')}}"
                ...
                <ul class="sidebar-menu " data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="{{ url('/siteAdmin/home_desc/show') }}">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li>
                                <a href="{{ url('/siteAdmin/services/show') }}">
                                    <i class="fa fa-circle-o"></i>
                                    Show / Edit
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/siteAdmin/services/add') }}">
                                    <i class="fa fa-circle-o"></i>
                                    Add
                                </a>
                            </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="/siteAdmin/Clinic/add">
                                    <i class="fa fa-circle-o"></i> Add Clinic
                                </a>
                            </li>
                            <li>
                                <a href="/siteAdmin/Clinic/show">
                                    <i class="fa fa-circle-o"></i> Show / Edit Clinic
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <a href="{{ url('/siteAdmin/user/add') }}">
                                    <i class="fa fa-circle-o"></i> Add
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/siteAdmin/user/show') }}">
                                    <i class="fa fa-circle-o"></i>
                                    Show / Edit
                                </a>
                            </li>
